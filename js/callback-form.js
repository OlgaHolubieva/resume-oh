...
const requestReceiveModal = document.querySelector('#modal-callback-request-id')
...
callbackForm.addEventListener('submit', function(event) {
    ...
    requestReceiveModal.classList.add('modal-active');

    setTimeout(function() {
        requestReceiveModal.classList.remove('modal-active');
